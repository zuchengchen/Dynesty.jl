...
- [`Compatibility`](compatibility.md) lists intentional public behavior
  differences.
- [`Migration Matrix`](migration_matrix.md) maps Python dynesty symbols and
  workflows to Julia-native implementations or replacements.
- [`Examples`](examples.md) lists smoke-tested Julia examples and benchmark
  helpers.
